...
export default function Sidebar({ isOpen = true, onClose }: SidebarProps) {
  ...
  const menuItems = [
    ...
    // TEMPORARILY HIDDEN: Live Signal feature - uncomment to restore
    // {
    //   name: 'Live Signal',
    //   href: '/live-signal',
    //   icon: (
              ...
              <Link
                ...
                className={`flex items-center space-x-3 px-4 py-3 rounded-lg transition-all ${
                  isActive
                    ...
                    : 'text-gray-400 dark:text-gray-400 light:text-gray-600 hover:text-white dark:hover:text-white light:hover:text-blue-600 hover:bg-white/5 dark:hover:bg-white/5 light:hover:bg-blue-50'
                }`}
              >
                {item.icon}
