    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-400">Your intelligent trading assistant powered by advanced AI</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-8">
          <div className="bg-black/50 backdrop-blur-xl rounded-2xl border border-white/10 flex flex-col" style={{ height: '600px' }}>
            {/* Chat Header */}
            ...
            <div className="p-4 border-t border-white/10">
              ...
              <div className="flex gap-2 mb-3 overflow-x-auto pb-2">
                {quickActions.map((action, index) => (
                  <button
                    ...
                    className="px-3 py-2 bg-white/5 hover:bg-white/10 border border-white/10 rounded-lg text-xs font-semibold whitespace-nowrap transition-all flex items-center gap-2"
                  >
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-blue-500/50 transition-all"
                />
                <button
                  onClick={handleSend}
                  disabled={!inputValue.trim()}
                  className="px-6 py-3 bg-gradient-to-r from-blue-500 to-blue-700 hover:from-blue-600 hover:to-blue-800 disabled:from-gray-600 disabled:to-gray-700 disabled:cursor-not-allowed rounded-xl font-semibold transition-all flex items-center gap-2"
                >
                  <span>Send</span>
        ...
        <div className="lg:col-span-4 space-y-4">
          ...
          <div className="bg-gradient-to-br from-blue-900/40 to-cyan-900/40 backdrop-blur-xl rounded-2xl border border-blue-500/30 p-4">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                ...
                <span className="text-lg font-bold text-green-400">76.5%</span>
              </div>
              <div className="flex justify-between items-center">
              ...
              <div className="flex justify-between items-center">
                <span className="text-sm text-gray-400">Profit (30d)</span>
                <span className="text-lg font-bold text-green-400">+23.4%</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-black/50 backdrop-blur-xl rounded-2xl border border-white/10 p-4">
            <h3 className="font-bold mb-3">Active Signals</h3>
            <div className="space-y-2">
              <div className="p-3 bg-green-500/10 border border-green-500/30 rounded-lg">
                <div className="flex items-center justify-between mb-1">
                  <span className="font-semibold">BTC/USDT</span>
                  <span className="text-xs px-2 py-0.5 bg-green-500/20 rounded text-green-400 font-semibold">LONG</span>
                </div>
                <p className="text-xs text-gray-400">Entry: $67,000 • TP: $70,000</p>
              </div>
              <div className="p-3 bg-green-500/10 border border-green-500/30 rounded-lg">
                <div className="flex items-center justify-between mb-1">
                ...
                <p className="text-xs text-gray-400">Entry: $3,200 • TP: $3,400</p>
              </div>
              <div className="p-3 bg-red-500/10 border border-red-500/30 rounded-lg">
                <div className="flex items-center justify-between mb-1">
                  <span className="font-semibold">SOL/USDT</span>
                  <span className="text-xs px-2 py-0.5 bg-red-500/20 rounded text-red-400 font-semibold">SHORT</span>
                </div>
                <p className="text-xs text-gray-400">Entry: $145 • TP: $138</p>
              </div>
            </div>
          </div>
          ...
          {/* Features */}
          <div className="bg-black/50 backdrop-blur-xl rounded-2xl border border-white/10 p-4">
            <h3 className="font-bold mb-3">AI Capabilities</h3>
            <div className="space-y-2 text-sm">
              <div className="flex items-center gap-2">
                <svg className="w-4 h-4 text-green-400" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                </svg>
                <span className="text-gray-400">Real-time market analysis</span>
              </div>
              <div className="flex items-center gap-2">
                <svg className="w-4 h-4 text-green-400" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                </svg>
                <span className="text-gray-400">Automated trade execution</span>
              </div>
              <div className="flex items-center gap-2">
                <svg className="w-4 h-4 text-green-400" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-400">24/7 market monitoring</span>
              </div>
            </div>
          </div>
        </div>
