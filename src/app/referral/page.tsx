          ...
          <div className="relative">
            ...
            <div className="p-4 sm:p-5 lg:p-6">
              ...
              {activeTab === 'transaction' && (
                <div className="animate-fadeIn">
                  <div className="text-center py-8 sm:py-12">
                    <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-purple-500/20 to-pink-500/20 backdrop-blur-xl rounded-full flex items-center justify-center mx-auto mb-4 light:from-purple-200 light:to-pink-200">
                      <span className="text-2xl sm:text-3xl">💳</span>
                    </div>
                    <p className="text-sm sm:text-base text-gray-400 mb-2 light:text-gray-600">Transaction History</p>
                    <p className="text-xs sm:text-sm text-gray-500 light:text-gray-600">View all commission transactions and payments</p>
                    
                    <div className="mt-6 sm:mt-8">
                      <div className="bg-white/5 backdrop-blur-xl rounded-xl p-4 sm:p-6 light:bg-blue-50">
                        <div className="flex items-center justify-between mb-4">
                          <span className="text-xs sm:text-sm font-medium text-gray-400 light:text-gray-600">Recent Transactions</span>
                        ...
                        <div className="text-center py-8">
                          <p className="text-xs sm:text-sm text-gray-500 light:text-gray-600">No transactions yet</p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              {activeTab === 'withdraw' && (
                <div className="animate-fadeIn">
                  <div className="text-center py-8 sm:py-12">
                    <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-yellow-500/20 to-orange-500/20 backdrop-blur-xl rounded-full flex items-center justify-center mx-auto mb-4 light:from-yellow-200 light:to-orange-200">
                      <span className="text-2xl sm:text-3xl">💰</span>
                    </div>
                    <p className="text-sm sm:text-base text-gray-400 mb-2 light:text-gray-600">Withdraw Earnings</p>
                    <p className="text-xs sm:text-sm text-gray-500 light:text-gray-600">Request withdrawal of your commission earnings</p>
                    
                    <div className="mt-6 sm:mt-8 max-w-md mx-auto px-4 sm:px-0">
                      <div className="bg-white/5 backdrop-blur-xl rounded-xl p-4 sm:p-6 light:bg-blue-50">
                        <div className="mb-6">
                          <p className="text-xs sm:text-sm text-gray-400 mb-2 light:text-gray-600">Available Balance</p>
                          <p className="text-2xl sm:text-3xl font-bold text-green-400 light:text-green-600">${stats.totalEarnings.toFixed(2)}</p>
                        </div>
                        ...
                        <button
                          ...
                          className={`w-full px-4 sm:px-6 py-2.5 sm:py-3 text-sm sm:text-base rounded-xl font-semibold transition-all ${
